...
shaka.dash.DashParser = class {
  ...
  async requestManifest_() {
    ...
    // Manifest Uris array.
    shaka.log.warning('response.uri');
    shaka.log.warning(response.uri);
  ...
  async parseManifest_(data, finalManifestUri) {
    ...
    shaka.log.warning('this.manifest_:');
    shaka.log.warning(this.manifest_);
    shaka.log.warning(`finalManifestUri: ${finalManifestUri}`);
    shaka.log.warning(data);
    if (!mpd) {
      throw new Error(
